...
// All handlers are wrapped in asyncHandler so any future async edit
// here can't silently hang the request — Express 4 doesn't forward
// promise rejections to next() on its own.
